    ...
    <ContainerStyled>
      <DetailModal>
        ...
        <div className="bg-modal">
          <div
            className={`modal-content border-3 ${
            ...
            <div className="content-modal">
              ...
              <div className="content-about">
                <span className="content-title">
                  <h2 className={`${state.theme ? "text-dark" : "text-light"}`}>
                    {singleData?.title}{" "}
                  </h2>
                  <h4 className={`${state.theme ? "text-dark" : "text-light"}`}>
                    {singleData?.release_date}{" "}
                  </h4>
                  <h6 className={`${state.theme ? "text-dark" : "text-light"}`}>
                    {" "}
                ...
                <div
                  className={`content-description mx-1 ${
                    state.theme ? "text-dark" : "text-light"
                  }`}
                >
                ...
                <ul className="content-crew">
                  {movieCrewData
                    ?.filter((item) =>
                      crewList.includes(item.job.toLowerCase())
                    )
                    .map((item) => (
                      <li className="crew-text">
                        {" "}
